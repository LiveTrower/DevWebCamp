...
class ActiveRecord {
    ...
    public static function unir($tabla1, $tabla2, $id) {
        $query = "SELECT ${tabla1}.* FROM ${tabla2} INNER JOIN ${tabla1} ON ${tabla2}.registro_id = ${tabla1}.id WHERE ${tabla2}.evento_id = ${id}";
        $resultado = self::$db->query($query);
        return $resultado;
    }
}